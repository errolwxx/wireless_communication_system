...
%% Pure aloha is chosen as MAC protocol for simulation:
...
Plen  = 7*8;                                    % length of a packet,7bytes
...
tcn = 8;                                       % capture ratio [dB]

                                                % definition of the access terminals
Mnum  = 1000;                                   % number of the access terminal
...
outfile = 'PA.dat';                             % result output file name
...
for G=[0.1:0.1:1,1.2:0.2:2]                     % offered traffic
    ...
    ts      = theorys(pno,traffic);                 % calculation of the theory value of the throughput
